...
data_contrasts <- test_diff(data_imputed, type = "manual", 
                              test = c("control468_vs_low468",
                                       "control231_vs_high231", "control468_vs_drug468", "control231_vs_drug231", "low468_vs_low_drug468", "high231_vs_high_drug231"))
```
...
```{r}
plot_heatmap(dep, type = "centered",  col_limit = 4,
...
```{r}
gsea_kegg_2021 = test_gsea(dep, databases = "KEGG_2016")
plot_gsea(gsea_kegg_2021)
```
