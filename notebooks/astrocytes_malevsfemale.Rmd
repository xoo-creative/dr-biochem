...
```{r}
#protein data
astro_raw_data <- read_tsv(file = '/Users/lucychi/Desktop/dr-biochem/data/astrocytes_combined_protein.tsv')

nrow(astro_raw_data)
#meta data
astro_meta_data <- read_tsv(file = '/Users/lucychi/Desktop/dr-biochem/data/astrocytes_experiment_annotation.tsv')
