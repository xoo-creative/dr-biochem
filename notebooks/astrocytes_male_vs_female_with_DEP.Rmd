...
```{r}
combined_proteins_file="combined_protein_astrocytes_sex_time.tsv"
experiment_annotation_file="experiment_annotation_astrocytes_sex_time.tsv"
...
```{r}
plot_volcano(dep, contrast = "female37_vs_male37", label_size = 2, add_names = TRUE)
```

```{r}
plot_volcano(dep, contrast = "female33_vs_male33", label_size = 2, add_names = TRUE)
```
